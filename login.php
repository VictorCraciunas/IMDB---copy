...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $username = $_POST["logusername"]; // Changed from logemail to logusername
...
<div class="card">
    ...
    <form action="login.php" method="post">
        <div class="field">
            ...
            <input autocomplete="off" id="logusername" placeholder="Username" class="input-field" name="logusername" type="text">
        </div>
        <div class="field">
            <svg class="input-icon" viewBox="0 0 500 500" xmlns="http://www.w3.org/2000/svg">
...
<!-- Sign Up button -->
<p class="positionLogIn">Don't have an account? <a href="signup.php">Sign Up</a></p>
</body>
</html>
